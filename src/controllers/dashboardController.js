...
//     const totalTasks = await runGet("SELECT COUNT(*) AS total FROM tasks");

//     // Dummy invoices array (until your real table works)
//     const invoices = [
...
//       clients: totalClients.total,     // 👈 matching EJS
//       tasks: totalTasks.total,         // 👈 matching EJS
//       invoices: invoices               // 👈 matching EJS
//     });
